    ...
    return (
      <div className="flex items-center justify-center mx-auto min-h-screen">
        <div role="status">
          <svg
            aria-hidden="true"
            className="w-12 h-12 text-gray-200 animate-spin dark:text-gray-200 fill-[#39576C]"
            viewBox="0 0 100 101"
            fill="none"
  ...
  return (
    <>
      <div className="w-screen min-h-screen bg-white">
        <div className="absolute right-48 top-20 md:hidden">
          <p className="text-gray-600 text-lg">{`Tenggat Waktu : ${new Date(
            tugasDetail.tanggalPengumpulan
        ...
        <div className="flex">
          ...
          <div className="ml-28 md:ml-24 mt-10">
            <p className="text-3xl md:text-2xl font-semibold">
              {tugasDetail?.mataPelajaran}
            </p>
            <p className="text-2xl font-inter md:text-xl font-semibold">
              {tugasDetail?.materi}
            </p>
            <div className="w-80 md:w-full h-0.5 bg-[#39576C] mt-1" />
            <p className="text-xl md:text-lg">{tugasDetail?.namaUser}</p>
            <p className="text-gray-600 text-lg hidden md:block md:mt-10">{`Tenggat Waktu : ${new Date(
              tugasDetail.tanggalPengumpulan
            ).toLocaleDateString()}`}</p>
          </div>
        </div>
        <div className="flex flex-wrap gap-10 mx-auto w-[90%] mt-32 md:mt-10 md:gap-4 md:justify-center mb-5">
          {loading ? (
            ...
            <div className="w-full">
              <p className="text-4xl text-gray-400 font-semibold text-center">
                Belum Ada Tugas
              </p>
        ...
        {isModalOpen && (
          <div className="w-1/5 md:w-4/5 border fixed bg-white right-28 md:left-2 bottom-0 h-2/5 md:h-fit md:pb-5 rounded-t-lg">
            <form
