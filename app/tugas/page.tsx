  ...
  return (
    ...
    <div className='w-screen min-h-screen bg-[#97C17E]'>
      <div className='flex'>
        ...
        <div className='ml-28 mt-10 text-white'>
          ...
          <p className='text-3xl font-semibold mt-16'>Tugas</p>
        </div>
      </div>
      <div className="flex flex-wrap gap-10 mx-auto w-[90%] mt-12">
      {loading ? (
          ...
          <div className='w-full'>
            <p className="text-4xl text-gray-500 font-semibold text-center">Belum Ada Tugas</p>
            {isStoredGuru == "true" && <p className="text-2xl text-gray-500 text-center">Tambah Tugas</p>}
          </div>
        ...
        tugasList.map((tugas, index) => (
          <CardTugas
            ...
            isi={tugas.isi}
            color={index % 3}
            pengumpulan={new Date(tugas.tanggalPengumpulan).toLocaleDateString()}
          />
        )))}
      </div>
