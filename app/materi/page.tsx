      ...
      <div className="w-screen min-h-screen bg-[#C1E2EA]">
        <div className="flex">
          ...
          <div className="ml-28 mt-10">
            ...
            <p className="text-3xl font-semibold mt-16">Materi</p>
          </div>
        </div>
        ...
        {loading ? (
          ...
          <div className="w-full">
            <p className="text-4xl text-gray-400 font-semibold text-center">Belum Ada Materi</p>
            {isStoredGuru == "true" && 
            <p className="text-2xl text-gray-400 text-center">Tambah Materi</p>}
          </div>
        ) : (
        materiList.map((materi, index) => (
          <CardMateri key={materi.id} id={materi.id} judul={materi.judul} namaUser={materi.namaUser} isi={materi.isi} color={index % 3}/>
        )))}
